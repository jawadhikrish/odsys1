 ...
 * @property integer $UTILIZADA
 * @property integer $APROVECHAMIENTO
 *
 * The followings are the available model relations:
 * @property Up $cOD
 */
class Capi extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Capi the static model class
	 */
	...
	public function search()
	{
		...
		$criteria->compare('APROVECHAMIENTO',$this->APROVECHAMIENTO);
